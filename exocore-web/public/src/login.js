...
var require_login = __commonJS({
  "public/login.jsx"() {
    ...
    var _tmpl$4 = /* @__PURE__ */ template(`<div class=login-page-wrapper><style>
                    :root {
                ...
                </style><div class=login-card><h1 class=login-header>Exocore Login</h1><div class=form-group><label class=form-label for=username>Username or Email</label><input id=username class=form-input type=text></div><div class=form-group><label class=form-label for=password>Password</label><div class=input-wrapper><input id=password class=form-input><button type=button class=password-toggle></button></div></div><button class=login-btn></button><div class=links-wrapper><a href=/private/server/exocore/web/public/forgot-password class=form-link>Forgot Password?</a><span class=links-separator>&bull;</span><a href=/private/server/exocore/web/public/register class=form-link>Register here`);
    var IconEye = () => _tmpl$();
    ...
    function App() {
      ...
      async function handleLogin() {
        ...
        try {
          ...
          if (!res.ok) {
            throw new Error(data.message || `Login HTTP error! status: ${res.status}`);
          }
      ...
      return createComponent(Show, {
        ...
        get children() {
          var _el$3 = _tmpl$4(), _el$4 = _el$3.firstChild, _el$5 = _el$4.nextSibling, _el$6 = _el$5.firstChild, _el$7 = _el$6.nextSibling, _el$8 = _el$7.firstChild, _el$9 = _el$8.nextSibling, _el$0 = _el$7.nextSibling, _el$1 = _el$0.firstChild, _el$10 = _el$1.nextSibling, _el$11 = _el$10.firstChild, _el$12 = _el$11.nextSibling, _el$13 = _el$0.nextSibling, _el$15 = _el$13.nextSibling;
          _el$9.addEventListener("keypress", handleKeyPress);
          _el$9.$$input = (e) => setForm((f) => ({
            ...f,
            user: e.currentTarget.value.replace(/\s/g, "")
          }));
          _el$11.addEventListener("keypress", handleKeyPress);
          _el$11.$$input = (e) => setForm((f) => ({
            ...f,
            pass: e.currentTarget.value.replace(/\s/g, "")
          }));
          _el$12.$$click = () => setShowPass(!showPass());
          ...
          _el$13.$$click = handleLogin;
          insert(_el$13, () => loading() ? "Logging in..." : "Login");
          insert(_el$5, createComponent(Show, {
            ...
            get children() {
              var _el$14 = _tmpl$3();
              insert(_el$14, status);
              createRenderEffect(() => className(_el$14, `status-message ${status().includes("successful") ? "status-success" : "status-error"}`));
              return _el$14;
            }
          }), _el$15);
          createRenderEffect((_p$) => {
            var _v$ = showPass() ? "text" : "password", _v$2 = loading() || !form().user || !form().pass;
            _v$ !== _p$.e && setAttribute(_el$11, "type", _p$.e = _v$);
          ...
          createRenderEffect(() => _el$9.value = form().user);
          createRenderEffect(() => _el$11.value = form().pass);
          return _el$3;
        }
      });
    }
