...
var require_forgot = __commonJS({
  "public/forgot.jsx"() {
    ...
    var _tmpl$3 = /* @__PURE__ */ template(`<p class=otp-subtext>Enter your username or email to receive a verification code.`);
    var _tmpl$4 = /* @__PURE__ */ template(`<div class=form-group><label class=form-label for=identifier>Username or Email</label><input id=identifier class=form-input type=text>`);
    var _tmpl$5 = /* @__PURE__ */ template(`<button class="btn btn-primary"type=submit>`);
    var _tmpl$6 = /* @__PURE__ */ template(`<div>`);
    var _tmpl$7 = /* @__PURE__ */ template(`<div class=otp-page-wrapper><style>
                :root {
            ...
            </style><div class=otp-card><form><h1 class=otp-header>Forgot Password</h1></form><div class=login-link-wrapper>Remembered your password? <a href=/private/server/exocore/web/public/login class=login-link>Login here`);
    var _tmpl$8 = /* @__PURE__ */ template(`<p class=otp-subtext>A code was sent. Enter it below with your new password.`);
    var _tmpl$9 = /* @__PURE__ */ template(`<div class=form-group><label class=form-label for=otpCode>Verification Code</label><input id=otpCode class="form-input otp-input"type=text placeholder=------ maxlength=6>`);
    var _tmpl$0 = /* @__PURE__ */ template(`<div class=form-group><label class=form-label for=newPass>New Password</label><div class=input-wrapper><input id=newPass class=form-input><button type=button class=password-toggle>`);
    var IconEye = () => _tmpl$();
    ...
    function App() {
      ...
      return (() => {
        var _el$3 = _tmpl$7(), _el$4 = _el$3.firstChild, _el$5 = _el$4.nextSibling, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$12 = _el$6.nextSibling;
        ...
        insert(_el$6, createComponent(Show, {
          ...
          get fallback() {
            return [_tmpl$8(), (() => {
              var _el$14 = _tmpl$9(), _el$15 = _el$14.firstChild, _el$16 = _el$15.nextSibling;
              _el$16.$$input = (e) => setOtpCode(e.currentTarget.value.replace(/\s/g, ""));
              createRenderEffect(() => _el$16.value = otpCode());
              return _el$14;
            })(), (() => {
              var _el$17 = _tmpl$0(), _el$18 = _el$17.firstChild, _el$19 = _el$18.nextSibling, _el$20 = _el$19.firstChild, _el$21 = _el$20.nextSibling;
              _el$20.$$input = (e) => setNewPass(e.currentTarget.value.replace(/\s/g, ""));
              _el$21.$$click = () => setShowPass(!showPass());
              ...
              createRenderEffect(() => setAttribute(_el$20, "type", showPass() ? "text" : "password"));
              createRenderEffect(() => _el$20.value = newPass());
              return _el$17;
            })(), (() => {
              var _el$22 = _tmpl$5();
              insert(_el$22, () => loading() ? "Resetting..." : "Reset Password");
              createRenderEffect(() => _el$22.disabled = loading() || !otpCode() || !newPass());
              return _el$22;
            })()];
          },
          get children() {
            return [_tmpl$3(), (() => {
              ...
              _el$1.$$input = (e) => setIdentifier(e.currentTarget.value.replace(/\s/g, ""));
              createRenderEffect(() => _el$1.value = identifier());
              return _el$9;
            })(), (() => {
              var _el$10 = _tmpl$5();
              insert(_el$10, () => loading() ? "Sending..." : "Send Code");
              createRenderEffect(() => _el$10.disabled = loading());
              return _el$10;
            })()];
          }
        }), null);
        insert(_el$5, createComponent(Show, {
          ...
          get children() {
            var _el$11 = _tmpl$6();
            insert(_el$11, status);
            createRenderEffect(() => className(_el$11, `status-message ${status().toLowerCase().includes("success") ? "status-success" : "status-error"}`));
            return _el$11;
          }
        }), _el$12);
        return _el$3;
